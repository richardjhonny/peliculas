...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
    	 ...
    	 <div class="footer-copyright full-reset all-tittles">peliculas..!! Richard</div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <p>Bienvenido a peliculas Richard espero que tengas una gran experiencia con nuestra plataforma online
                        le recomendamos las siguientes peliculas gracias......!!.</p>
                </div>
            </div>
        </div>
        <div class="container-fluid">
